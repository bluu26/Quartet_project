"""
Django settings for Band_man_project project.
...
SECRET_KEY = 'django-insecure-ou=dpbx4+4#-m6oh3$#2kspv_p*53v#*x#syn8t2%4$_1j$n09'
...
ROOT_URLCONF = 'Band_man_project.urls'
...
WSGI_APPLICATION = 'Band_man_project.wsgi.application'
